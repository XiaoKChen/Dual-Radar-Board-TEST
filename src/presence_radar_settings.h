...
#define XENSIV_BGT60TRXX_CONF_SAMPLE_RATE (720721)
#define XENSIV_BGT60TRXX_CONF_CHIRP_REPETITION_TIME_S (0.000199962)
#define XENSIV_BGT60TRXX_CONF_FRAME_REPETITION_TIME_S (0.997029)
